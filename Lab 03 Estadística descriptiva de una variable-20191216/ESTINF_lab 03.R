...
# Todos los estadísticos descriptivos de una variable y la tabla de frecuencias
# de manera conjunta con el paquete(libreria) DESCTOOLS
library(DescTools)

# Tabla de frecuencias para variables cualitativas nominales y ordenadas
#options(scipen = 3)    #suprime la notación exponencial en una tabla de frecuencias
Freq(act_fisi)
Freq(estudios)
Freq(cafe)
Freq(genero)
...
#===========================================================================================
# Estadística descriptiva de una variable númerica, dentro del programa básico STATS
summary(estudios)
summary(edad)
min(edad)
max(edad)
